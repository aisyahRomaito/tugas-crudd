    ...
    <div className="bg-gray-200 min-h-screen">
      <div className="container mx-auto p-8">
        <header className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Daftar Film Indonesia</h1>
          <button
            onClick={() => setShowAdd(true)}
            className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-6 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Tambah Film
          </button>
        </header>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
              ...
              <form onSubmit={handleAddFilm}>
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-6 rounded-lg mr-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  >
                    Simpan
                  </button>
                  <button
                    type="button"
                    className="bg-gray-400 hover:bg-gray-600 text-white py-2 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <input
            ...
            className="block w-full mb-4 p-3 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
            value={search}
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <select
                id="sortby"
                className="border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                value={sortBy}
              ...
              <select
                className="ml-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                value={sortOrder}
          ...
          {filteredFilms.length > 0 ? (
            filteredFilms.map((film) => (
              <div key={film.id} className="bg-gray-100 rounded-lg p-4 mb-4">
